...
export const createUserCard = ({ // 받는것도 객체여야 함. 받자마자 구조분해할당, 기본값까지 설정하면 언디파인드 안나옴
  id = '',
  name = '',
  email = '',
  website = ''
...
// renderSpinner 함수 만들기
export const renderSpinner = (target, data) => {
  return insertLast(target, createSpinner(data))
}

export const renderUserCard = (target, data) => {
  return insertLast(target, createUserCard(data))
}
